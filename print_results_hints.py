...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture",model.upper(), 
          "***")
    print("{:20}: {:3d}".format('N Images', results_stats_dic['n_img']))
    print("{:20}: {:3d}".format('N Dog Images', results_stats_dic['n_dog_img']))
    ...
    #          results_stats_dic
    #
    print(f"N Not-Dog Images:{results_stats_dic['n_not_dogimg']}")
